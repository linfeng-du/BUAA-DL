...
def train(args, teacher_network):
    ...
    with g1.as_default():
        ...
        loss = tf.losses.softmax_cross_entropy(logits, label_onehot) + 
                args.tempreture * args.tempreture * tf.losses.softmax_cross_entropy(logits/args.temperature, target_label_onehot)
